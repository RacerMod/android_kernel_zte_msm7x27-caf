...
#ifdef CONFIG_ZTE_PLATFORM
	GPIO_CFG(90, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* WAKE - ZTE_BT_QXX_20100709*/
#else
...
#ifdef CONFIG_ZTE_PLATFORM //ZTE_BT_QXX_20100709
