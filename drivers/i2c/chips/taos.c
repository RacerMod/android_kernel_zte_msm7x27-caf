...
static u16 prox_threshold_hi_param = 8500; /*ZTE_ALSPRX_004*/
static u16 prox_threshold_lo_param = 8000;
#elif defined(CONFIG_MACH_JOE)
static u16 prox_threshold_hi_param = 4500; /*ZTE_ALSPRX_005*/
static u16 prox_threshold_lo_param = 4000;
#elif defined(CONFIG_MACH_MOONCAKE)
static u16 prox_threshold_hi_param = 18000; /*ZTE_ALSPRX_005*/
static u16 prox_threshold_lo_param = 17500;
#else
static u16 prox_threshold_hi_param = 9500; /*ZTE_ALSPRX_006*/
