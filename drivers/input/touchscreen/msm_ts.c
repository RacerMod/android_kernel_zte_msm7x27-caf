...
#endif
	struct device			*dev;
	struct timer_list timer; //wly ZTE_TS_ZT_005 @2010-03-05
};
...
static ssize_t virtualkeys_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	sprintf(buf,"%s\n",ts_keys_size);
	printk("wly:%s\n",__FUNCTION__);
...
/*ZTE_TS_ZT_004 @2010-01-28 delete for compile err, start*/
/*
...
*/
/*ZTE_TS_ZT_004 @2010-01-28 delete for compile err, end*/
...
err_tsadc_register:
*/
/* ZTE_TS_ZT_004 @2010-01-28 for virtual key not used in driver, end*/
