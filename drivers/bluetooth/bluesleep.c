...
static int msm_btinfo_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data)
{
	int len = 0;
...
static int msm_btinfo_write_proc(struct file *file, const char __user *buffer, unsigned long count, void *data)
{
	return 1;
}
